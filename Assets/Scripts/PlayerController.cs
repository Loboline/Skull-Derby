...
{
    public float playerSpeed = 20.0f; //var for the speed the player currently has
    ...
    void FixedUpdate()
    {
        MovePlayer(); //funktionen som kallas sköter den konstanta hastigheten som playern har.
        NitroActivation(); //funktionen som kallas kollar om någon trycker på Space-knappen för speedboost, och om charges finns kvar: öka farten
    }
